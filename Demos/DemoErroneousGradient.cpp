...
//   Helpers::FilterImage<RGBImageType, UnsignedCharScalarImageType, itk::RGBToLuminanceImageFilter<RGBImageType,
//                        UnsignedCharScalarImageType> >(imageReader->GetOutput(), image);
