...
#ifndef ClassicalImageInpaintingBlurredBasicViewer_HPP
#define ClassicalImageInpaintingBlurredBasicViewer_HPP
...
void ClassicalImageInpaintingBlurredBasicViewer(typename itk::SmartPointer<TImage> originalImage,
