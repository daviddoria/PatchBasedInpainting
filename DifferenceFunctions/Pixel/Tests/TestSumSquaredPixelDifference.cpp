...
#include "SumSquaredPixelDifference.hpp"
...
int main(int, char*[])
{
  ...
  SumSquaredPixelDifference<PixelType> ssd;

  float difference = ssd(pixelA, pixelB);

  std::cout << "ssd: " << difference << std::endl;

  return EXIT_SUCCESS;
}

// TODO: Move these test functions to the appropriate test file.
