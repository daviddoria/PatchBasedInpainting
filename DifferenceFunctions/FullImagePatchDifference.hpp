#ifndef FullImagePatchDifference_hpp
#define FullImagePatchDifference_hpp
 ...
 *  This class differs from ImagePatchDifference in that all patches are assumed to be completely inside the image.
 */
template <typename ImagePatchType, typename PixelDifferenceFunctorType>
struct FullImagePatchDifference
{
  PixelDifferenceFunctorType PixelDifferenceFunctor;

  FullImagePatchDifference(PixelDifferenceFunctorType pixelDifferenceFunctor = PixelDifferenceFunctorType()) :
