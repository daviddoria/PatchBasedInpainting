...
#ifndef PixelDifferenceFullSquared_H
#define PixelDifferenceFullSquared_H

#include "PixelDifferenceFull.h"

template <typename TPixel>
struct PixelDifferenceFullSquared
{
public:
  PixelDifferenceFullSquared(const TPixel& examplePixel)
  {
    this->NumberOfComponentsPerPixel = examplePixel.GetNumberOfElements();
  }

  PixelDifferenceFullSquared(const unsigned int numberOfComponents)
  {
  ...
  {
    float difference = PixelDifferenceFull<TPixel>::Difference(a, b, numberOfComponents);
