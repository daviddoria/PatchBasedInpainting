...
#ifndef PatchDifferencePixelWiseSum_H
#define PatchDifferencePixelWiseSum_H
...
public:
  ...
  float Difference(const PatchPair<TImage>& patchPair, const std::vector<itk::Offset<2> >& offsetsToCompare) const;
};
