...
int main(int argc, char *argv[])
{
  ...
  typedef ImagePatchTopology<ImageType> TopologyType1;
  TopologyType1 space1;
  
  typedef FeatureVectorTopology TopologyType2;
  TopologyType2 space2;
  ...
  typedef boost::vector_property_map<TopologyType1::point_type, IndexMapType> DescriptorMapType1;
  DescriptorMapType1 descriptorMap1(num_vertices(graph), indexMap);
  
  typedef boost::vector_property_map<TopologyType2::point_type, IndexMapType> DescriptorMapType2;
  ...
  typedef TwoStepNearestNeighbor<VertexDescriptorType, TopologyType1, DescriptorMapType1, TopologyType2, DescriptorMapType2> SearchType;
  SearchType nearestNeighborFinder(space1, descriptorMap1, space2, descriptorMap2, 100);
  nearestNeighborFinder.DVPTree = &tree;
